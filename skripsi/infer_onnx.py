...
class InferOnnx():
    ...
    def init_model(self):
        sess = onnxruntime.InferenceSession(self.model_path, providers=[('TensorrtExecutionProvider', {'trt_engine_cache_enable':True, 'trt_engine_cache_path':"/home/app/cache"})])
        return sess
